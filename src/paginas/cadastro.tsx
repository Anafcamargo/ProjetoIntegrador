  ...
  return (
    <div className="vocadastro">
      ...
      <div className="paicaixa">
        <div className="caixadeselecao">
          {" "}
          CADASTRO DE USÚARIO <input type="radio" name="usuario/voluntario" />
        </div>
        <div className="caixadeselecao2">
          {" "}
          CADASTRO DE VOLUNTÁRIO{" "}
          <input type="radio" name="usuario/voluntario" />
        </div>
      </div>
      <div className="paicadastro">
        <div>
          <img src="logo2.png" alt="" className="logocadastro" />
        </div>
        ...
        <div className="CadUsuario">
          ...
          <br />
          ENDEREÇO: <input type="text" placeholder="Insira seu endereço" />{" "}
          <br />
        ...
        <div className="CadVoluntario">
          ...
          <input
            type="text"
            placeholder="Escreva um ouco sobre você"
            className="CadBio"
          />
          <input type="submit"></input>
        </div>
